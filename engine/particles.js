    ...
    },
    {
        ...
        __updateParticle: function(particle, dt) {
            ...
            if (lp){ // oriented by position
                ...
                particle.__lastPosition.copy(pos);
...
EffectComponentsFactory.__registerComponent('c', 
    ...
    
    {
        ...
        __initParticle: function(particle){
            particle.__start_color = this.g.color( particle.__emitter.__part ).clone().__divideScalar(255);
        }
...
function Particle(emitter, part, matrixOrParticle, dtMult){
    ...
    var pos = t.__current_position = emitter.g.origin(part).clone();
...
//         consoleLog (t. __current_velocity, t.__current_position);
    ...
    __worldPosition: {
        get: function(){
            var v = this.__current_position.clone();
            v.y *= -1;
            return v;
        }
    },
...
ParticleEmitter.prototype = mergeObj( ObjectCreate( Object3D.prototype ), {
    ...
    __init: function(parameters){
        ...
        t.__nodePosition.copy(t.__parent.__worldPosition);
    ...
    __render: function(){
        ...
        if (t.linked) {
            ...
            if (mw.e) {
                t.__projectionMatrix = t.__projectionMatrix.clone();
...
//          t.__drawMode = randomInt(0,3);
    ...
    __update:function(dt){
        ...
        if (t.____enabled && ((t.duration < 0) || (t.__elapsed < t.duration)))
        {
            ...
            if (scr) {
                t.__nodeScrollPosition.copy( scr );
            }
            ///
            ////////////////////////////////////////////////////////////////////////
            t.__elapsed += dt;
...
makeClass( ParticleEffect, {
    ...
    __removeFromParent : function(){
        ...
        for (var i = 0; i < t.emitters.length; i++){
            ...
            if (e.parent) e.parent.__removeChild( e );
        }
        t.emitters = [];
        t.__enabled = 0;
    },
...
var particlesPropertiesDescriptions  = {
    ...
    emitter: {
        ...
        blending:{ type:'list', label:'blending',
