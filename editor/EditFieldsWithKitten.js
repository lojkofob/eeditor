...
//         consoleLog(property,input);
    ...
    checkSingleton: function(){
        ...
        if (!this.__on){
            ...
            htmlInput.onblur = function(){ if ( EditFieldsWithKitten.focusedInput ) 
                EditFieldsWithKitten.focusedInput.unfocus(); }
            htmlInput.onwheel = function(e){ if ( e && e.deltaY && EditFieldsWithKitten.focusedInput && EditFieldsWithKitten.focusedInput.__numericInputStep) {
            ...
            htmlTextarea.onblur = function(){ if ( EditFieldsWithKitten.focusedInput ) 
                EditFieldsWithKitten.focusedInput.unfocus(); }
...
//                     consoleLog(d);
    ...
    unbindInput: function(t, disableparentCheck){
        if (t){
            ...
            if (!disableparentCheck && t.parent){
                if (t.parent.__parts || t.name == 'value') {
                    t.name = 0;
                    return this.unbindInput(t.parent);
                }
            }
...
//                      lockPointer();
            ...
            updateHtmlInput: function(){
                ...
                if (this.htmlInput) {
                    ...
                    var pos = this.__worldPosition.clone() // .__multiplyScalar(1/layoutsResolutionMult)
                        , sz = this.__size;
                    
                    pos.sub( sz.clone().__divideScalar(2) ).add( this.__parentScrollVector );
...
//                          debugger;
                        ...
                        if (!dropPanel.parent.__initialZ) {
                            dropPanel.parent.__initialZ = dropPanel.parent.__z;
                        }
                        dropPanel.parent.__z = dropPanel.__visible ? -25 : dropPanel.parent.__initialZ;
                        ...
                        if (dropPanel.__visible) {
                            ...
                            BUS.__addEventListener({
                                __ON_POINTER_UP(){
                                    ...
                                    dropPanel.parent.__z = dropPanel.parent.__initialZ;
                                    return 1;
                                }
                            });
                        }
...
//             } );
           ...
           /* vi = vi.sort( function(a, b){
            ...
            function isInOneParent(a, b){ 
                ...
                if ( a.parent.parent == b.parent ){
                    return 1;
                }
                
                if ( a.parent == b.parent.parent ){
                    return 1;
                }
            ...
            if (ffind( function(a){  return isInOneParent(a.parent, fi.parent) && a.__worldPosition.y == wp.y && a.__worldPosition.x > wp.x; }))
                return;
            
            if (ffind( function(a){  return isInOneParent(a.parent, fi.parent) && a.__worldPosition.y > wp.y }))
                return;
                
            if (ffind( function(a){  return isInOneParent(a.parent.parent, fi.parent.parent) && a.__worldPosition.y == wp.y && a.__worldPosition.x > wp.x; }))
                return;
            
            if (ffind( function(a){  return isInOneParent(a.parent.parent, fi.parent.parent) && a.__worldPosition.y > wp.y }))
                return;
