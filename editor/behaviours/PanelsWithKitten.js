                ...
                n.header.__init({
                    ...
                    __dragStart: function () {
                        ...
                        if (panelAcceptor) {
                            ...
                            var pos = n.__worldPosition.__clone();

                            panelAcceptor.__removeChild(n);

                            panelAcceptor.__root.__addChildBox(n);

                            n.__parent.__updateMatrixWorld(1);
                            ...
                            var pos2 = n.__worldPosition.__clone();
