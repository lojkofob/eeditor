...
var checkinterval, navpanels = new HitTestObjects(function(n){
    return n.__isNavPanel || (n.parent||0).__isNavPanel
...
function updatePanelsVisibility(){
    ...
    $each( navpanels__a, p => {
        if (!p.__checkedHitTest && p.__visible && !p.parent.__checkedHitTest && (TIME_NOW - p.__showTime > 1)) {
        ...
        if (!but.panel.__llpp){
            ...
            looperPost( function(){
                ...
                but.panel.__traverse( function(p){
                    ...
                    if (p.parent == but.panel && p.__onTap && p.__mmmin == undefined)  {
                        p.__mmmin = 0;
                        ObjectDefineProperties(p, {
                            __mouseIn: {
                                set: function(v){
                                    this.__mmmin = v;
                                    if (lastPanelShowed!=this.parent)
