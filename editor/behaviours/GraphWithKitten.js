...
//             __ofs:{ x:x, y:y, z:-1 },
            ...
            __select: function(){
                if (!isShiftPressed)
                    this.parent.parent.$({__selected:1}).__unselect();
                this.__selected = 1;
                this.__color = 0x7777ff;
                this.parent.graphProxyObject.updateInputs();
                return 1;
            },
...
//                 ae[ 11 ] = 0;
            ...
            __drag:function(x,y,dx,dy){
                ...
                p.graphProxyObject.translatePoints(dx, dy, t.parent);
                 
            }
        } );
        
        if ( t.__lastPoint  && n.parent.curveData[n.index][0] == t.__lastPoint[0] && n.parent.curveData[n.index][1] == t.__lastPoint[1] ){
            t.__lastPoint = 0;
            n.__select();
        }
...
GraphProxyObject.prototype = {
    ...
    updateInputs: function(){
        ...
        EditFieldsWithKitten.updateAllPropsIn( this.node.parent.parent )
    },
...
//                 return;
    ...
    translatePoints: function( dx, dy, line) {
        ...
        this.node.__traverse(function(t){ 
            if (t.__selected) {
                if (!line || (line == t.parent) ) {
                  
                    var p = t.parent, j = t.index,
                        point = p.curveData[j];
...
//             consoleLog(this.objectToChange, this.prop);
    ...
    selectedx:{
        ...
        get: function(){
            var x = this.node.__traverse(function(n){
                if (n.__selected) {
                    return n.parent.curveData[n.index][0] * n.parent.length;
                }
            })
            return x;
        }
    ...
    selectedy:{
        ...
        get: function(){
            return this.node.__traverse(function(n){ 
                if (n.__selected) {
                    return n.parent.curveData[n.index][1]
                }
            })
        }
    },
    ...
    __easing:{
        ...
        get: function(){
            return this.node.__traverse(function(n){ 
                if (n.__selected) {
                    return n.parent.curveData[n.index][2]||0
                }
            })
        }
    }
...
addEditorEvents('Graph', {
    ...
    openGraph: function(d){
        ...
        if (objectToChange){
            GraphWithKitten.openGraph(but.parent, objectToChange.objectToChange, objectToChange.prop);
        }
