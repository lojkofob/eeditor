...
mergeObjectDeep( EditorUIBehavioursWithKitten, { 
    ...
    behaviours: {
        ...
        colorPicker: function(n){
            ...
            ColorPickerPanel.parent.__visible = 0;
            
            ColorPickerPanel.parent.__wheel = 1;
            ...
            function prepareSlider(sl){
                ...
                slider.__wheel = function(d){
                    ...
                    var val = proxyColorObject[ this.parent.name ],
                        v = val.__isColor ? ( val.r + val.g + val.b) / 3 : val;
                    proxyColorObject[ this.parent.name ] = (v - d * (isShiftPressed ? 0.1 : 0.01));
				...
				slider.__canDrag = function(x,y,dx,dy){
                    ...
                    thumb.__x = x;
                    proxyColorObject[ this.parent.name ] = (x + sx - 6) / (sx - 6)/ 2;
                    return 1;
                }
...
function updateColorPicker(){
     if (ColorPickerPanel && ColorPickerPanel.parent.__visible) {
