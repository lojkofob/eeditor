...
//                                 console.log("contextMenuPanel.li");
                    ...
                    contextMenuPanel.__x = clamp( mouse.x, 0, __screenSize.x - contextMenuPanel.__width);
                    contextMenuPanel.__y = clamp( mouse.y, 0, __screenSize.y - contextMenuPanel.__height);
