...
*/
static void 
processIFDOffset(FITAG *tag, char *pval, FIBOOL msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model) {
	// get the IFD offset
...
*/
static void 
processMakerNote(FIBITMAP *dib, char *pval, FIBOOL msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model) {
	FITAG *tagMake = NULL;
...
*/
static FIBOOL 
jpeg_read_exif_dir(FIBITMAP *dib, const BYTE *tiffp, unsigned long offset, unsigned int length, FIBOOL msb_order) {
	WORD de, nde;
