...
static void
ReadData(FreeImageIO *io, fi_handle handle, BYTE *buf, DWORD length, BOOL_FreeImage rle) {
...
Load(FreeImageIO *io, fi_handle handle, int page, int flags, void *data) {
	...
	BOOL_FreeImage rle;			// TRUE if RLE file
	BOOL_FreeImage isRGB;			// TRUE if file type is RT_FORMAT_RGB
	BYTE fillchar;
