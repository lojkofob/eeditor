...
static unsigned
readline(FreeImageIO &io, fi_handle handle, BYTE *buffer, unsigned length, BOOL_FreeImage rle, BYTE * ReadBuf, int * ReadPos) {
	// -----------------------------------------------------------//
...
Load(FreeImageIO *io, fi_handle handle, int page, int flags, void *data) {
	...
	BOOL_FreeImage bIsRLE;		  // True if the file is run-length encoded
	...
	try {
		...
		BOOL_FreeImage validated = pcx_validate(io, handle);		
