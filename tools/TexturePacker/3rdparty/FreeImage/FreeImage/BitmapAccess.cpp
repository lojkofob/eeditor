...
FI_STRUCT (FREEIMAGEHEADER) {
	...
	FIBOOL transparent;			// why another table? for easy transparency table retrieval!
	...
	FIBOOL has_pixels;			// FALSE if the FIBITMAP only contains the header and no pixel data
...
*/
static size_t 
FreeImage_GetImageSizeHeader(FIBOOL header_only, unsigned width, unsigned height, unsigned bpp) {
