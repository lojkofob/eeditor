...
mng_ReadChunks(int format_id, FreeImageIO *io, fi_handle handle, long Offset, int flags = 0) {
	...
	BOOL_FreeImage m_HasGlobalPalette = FALSE; // may turn to TRUE in PLTE chunk
	...
	BOOL_FreeImage hasBkColor = FALSE;
	BOOL_FreeImage mHasIDAT = FALSE;
