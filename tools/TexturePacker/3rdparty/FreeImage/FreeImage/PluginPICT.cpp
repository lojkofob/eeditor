...
static void 
DecodeBitmap( FreeImageIO *io, fi_handle handle, FIBITMAP* dib, BOOL_FreeImage isRegion, MacRect* bounds, WORD rowBytes ) {
...
static void 
DecodePixmap( FreeImageIO *io, fi_handle handle, FIBITMAP* dib, BOOL_FreeImage isRegion, MacpixMap* pixMap, WORD rowBytes ) {
...
Load(FreeImageIO *io, fi_handle handle, int page, int flags, void *data) {
	...
	try {		
		...
		WORD rowBytes = 0;
		BOOL_FreeImage isRegion = FALSE;
		BOOL_FreeImage done = FALSE;
		long currentPos = 0;
