...
function crop(img, out, coords, needSize){
      ...
      console.log("convert " + img + " -quality 90 -crop " + size + "+" + offset + " -resize " + needSize + "\\! "+out);
      cp.exec("convert " + img + " -quality 90 -crop " + size + "+" + offset + " -resize " + needSize + "\\! "+out);
      
}

fs.readFile('./project/new_room_preview.json', 'utf8', function (err, data) {
  ...
  for (var room in t){
    var coords = t[room];
    crop(
      './project/newrooms/'+room+'/atlas-1.png',
      './project/newrooms/'+room+'/back.b.jpg',
    ...
    crop(
      './project/newrooms/'+room+'/atlas-1.png',
      './project/newrooms/'+room+'/back.s.jpg',
